...
const Career = () => {
  return (
    ...
    <div className="min-h-screen">
      {/* <div className="">
        <img src={ai} alt="asthramedtech-ai" className="w-full pt-10" />
      <div className=""><p className="absolute">jytjuiyi</p></div>
      </div> */}
      {/* <div className="relative">
  <img src={ai} alt="asthramedtech-ai" className="w-full pt-10" />
  <div className="absolute flex items-center justify-center">
    <p className="text-white bg-black bg-opacity-50 p-2   ">jytjuiyi</p>
  </div>
</div> */}
